...
class PdoGsb{   		
      	...
      	private static $bdd='dbname=GSB1';   		
      	private static $user='samantha' ;    		
      	private static $mdp='samy4231' ;	
 ...
 */
	...
	public function creerCompterendu($refPraticien,$date,$niveauinteret,$refVisiteur){
		$dateFr = dateFrancaisVersAnglais($date);
		$req = "insert into Visite (refPraticien,finDeVisite,niveauInteret,refVisiteur)
				values('$refPraticien','$dateFr','$niveauinteret','$refVisiteur')";
		PdoGsb::$monPdo->exec($req);
	}
}
?>